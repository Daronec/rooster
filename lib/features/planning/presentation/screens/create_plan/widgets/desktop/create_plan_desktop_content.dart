...
/// Контент экрана создания плана (desktop).
///
/// Кнопки «Сохранить» и «Отмена» находятся только в AppBar.
class CreatePlanDesktopContent extends StatelessWidget {
  /// Создаёт контент.
  const CreatePlanDesktopContent({required this.wm, super.key});
        ...
        body: Center(
          child: ConstrainedBox(
            ...
            child: SingleChildScrollView(
              ...
              child: _CreatePlanDesktopForm(wm: wm),
            ),
          ),
        ),
      ),
...
/// Форма создания плана (desktop).
class _CreatePlanDesktopForm extends StatelessWidget {
  const _CreatePlanDesktopForm({required this.wm});
      ...
      children: <Widget>[
        ...
        Row(
          children: <Widget>[
            ...
            const SizedBox(width: AppSizes.double16),
            Expanded(
              child: ValueListenableBuilder<DateTime>(
