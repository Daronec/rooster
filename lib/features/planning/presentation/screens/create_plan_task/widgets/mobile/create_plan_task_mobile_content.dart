...
/// Контент экрана создания задачи плана (mobile).
class CreatePlanTaskMobileContent extends StatelessWidget {
  /// Создаёт контент.
  const CreatePlanTaskMobileContent({required this.wm, super.key});
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: _CreatePlanTaskForm(wm: wm),
      ),
    );
  }
}

/// Форма создания задачи плана.
class _CreatePlanTaskForm extends StatelessWidget {
  const _CreatePlanTaskForm({required this.wm});
