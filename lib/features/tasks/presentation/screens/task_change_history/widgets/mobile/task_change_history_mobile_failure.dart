...
/// Ошибка загрузки истории изменений (mobile).
class TaskChangeHistoryMobileFailure extends StatelessWidget {
  /// Создаёт виджет.
  const TaskChangeHistoryMobileFailure({required this.onRetry, super.key});
