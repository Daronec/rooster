...
/// Загрузка экрана деталей задачи (mobile).
class TaskDetailMobileLoading extends StatelessWidget {
  /// Создаёт виджет.
  const TaskDetailMobileLoading({super.key});
    ...
    return AppScaffold(
      ...
      body: Center(
        child: Padding(
          ...
          child: Text(TaskDetailStrings.loadingBody(context)),
        ),
      ),
    );
  }
