...
/// Контент экрана списка задач (mobile): AppBar, FAB и сгруппированный список.
class TasksMobileContent extends StatelessWidget {
  /// Создаёт контент.
  const TasksMobileContent({required this.wm, super.key});
