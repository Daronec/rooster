...
/// Полноэкранная ошибка на экране создания задачи (mobile).
class CreateTaskMobileFailure extends StatelessWidget {
  /// Создаёт виджет.
  const CreateTaskMobileFailure({
    required this.wm,
...
/// Блок ошибки загрузки списков внутри формы (mobile).
class CreateTaskMobileListsFailurePanel extends StatelessWidget {
  /// Создаёт виджет.
  const CreateTaskMobileListsFailurePanel({
    required this.onRetry,
    super.key,
  });
